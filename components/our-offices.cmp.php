<section class="offices-section gray-bg pb-0">
    ...
    <div class="container">
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 form-column flex">
                    <div class="contact-form-area flex" style="display:inline-block;">
                        <div class="info-box clearfix float-left">
                            <div class="single-info pr-3">
                                <div class="icon-box"></div>
                                <h3>Meet Us</h3>
                                <p><i class="flaticon-house"></i> Kisoboka Building,  <br /> Muyenga, Uganda </p>
                            </div>
