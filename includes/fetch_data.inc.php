			...
			foreach ($result as $allposts => $all) {
				...
				echo'<div class="col-lg-4 col-md-6 col-sm-12 news-block wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
						<div class="news-block-one">
							<figure class="image-box"><a href="blog_details.php?id='.$all['post_id'].'&name='.$slug.'"><img src="dashboard/post-uploads/'.$all['post_picture'].'" alt="" ></a></figure>
							<div class="lower-content">
								<ul class="post-info">
									<li><i class="far fa-calendar-alt"></i> '.$new_date.' </li>
									<li><i class="fa fa-tag"></i> '.$all['post_category'].' </li>
								</ul>
								<h4><a href="blog_details.php?id='.$all['post_id'].'&name='.$slug.'"> '.$small_title.' </a></h4>
							</div>
						</div>
					</div>' ;
			$i++;
